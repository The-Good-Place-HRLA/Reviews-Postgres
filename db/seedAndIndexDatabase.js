...
var inputFile = path.join(__dirname, './products.csv')
var table = 'testtable'
...
const tableCreate = 'CREATE TABLE IF NOT EXISTS testtable(productID integer NOT null, name varchar(50) NOT null)'
...
const executeQuery = (targetTable) => {
    ...
    execute(targetTable, (err) =>{
        ...
        stream.on('end', () => {
            ...
            .then(() => {
                seedClient.connect()
                seedClient.query(`ALTER TABLE ${targetTable} ADD PRIMARY KEY (productID);`, err => {  
                    if (err) {
                    console.log(err);
                    }
                    else {
